...
const transform_interceptor_1 = __webpack_require__(28);
const core_2 = __webpack_require__(4);
const nest_winston_1 = __webpack_require__(17);
const allException_filter_1 = __webpack_require__(30);
...
const roles_entity_1 = __webpack_require__(25);
const profile_entity_1 = __webpack_require__(12);
const logs_module_1 = __webpack_require__(26);
            ...
            typeorm_1.TypeOrmModule.forRootAsync({
                ...
                useFactory: (configService) => {
                    return {
                        ...
                        logging: ['error'],
                        entities: [user_entity_1.User, roles_entity_1.Roles, profile_entity_1.Profile]
                    };
                }
            }),
...
const user_entity_1 = __webpack_require__(10);
const profile_entity_1 = __webpack_require__(12);
const nestjs_pino_1 = __webpack_require__(18);
let UserModule = class UserModule {
};
exports.UserModule = UserModule;
exports.UserModule = UserModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([user_entity_1.User, profile_entity_1.Profile]), nestjs_pino_1.LoggerModule.forRoot()],
...
exports.UserController = UserController = __decorate([
    ...
    __param(1, (0, common_2.Inject)(nest_winston_1.WINSTON_MODULE_NEST_PROVIDER)),
    __metadata("design:paramtypes", [typeof (_a = typeof user_service_1.UserService !== "undefined" && user_service_1.UserService) === "function" ? _a : Object, typeof (_b = typeof common_2.LoggerService !== "undefined" && common_2.LoggerService) === "function" ? _b : Object])
], UserController);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const node_fs_1 = __webpack_require__(21);
const yaml = __webpack_require__(22);
const node_path_1 = __webpack_require__(23);
const _ = __webpack_require__(24);
const commonFilePath = (0, node_path_1.join)(__dirname, '../config', `config.yaml`);
const envFilePath = (0, node_path_1.join)(__dirname, '../config', `config.${process.env.NODE_ENV || 'dev'}.yaml`);
...
const common_1 = __webpack_require__(6);
const nest_winston_1 = __webpack_require__(17);
const winston_1 = __webpack_require__(27);
...
/******/ 	(() => {
/******/ 		__webpack_require__.h = () => ("86c53483cdfe6fd08c9d")
/******/ 	})();
/******/ 	
